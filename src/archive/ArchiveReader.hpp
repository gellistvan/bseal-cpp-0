...
namespace bseal::archive {
    ...
    class ArchiveReader {
      public:
        ...
        // Verifies ArchiveEnd, closes files, promotes temporary output into the final output root,
        // and removes temporary extraction state.
        void finish();
      ...
      private:
        ...
        temp_path_for(const std::filesystem::path &archive_path) const;

        [[nodiscard]] std::filesystem::path
        final_path_for(const std::filesystem::path &archive_path) const;

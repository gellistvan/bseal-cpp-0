...
namespace bseal::io {
    ...
    inline constexpr std::array<Byte, 8> kGlobalHeaderV1Magic{
        static_cast<Byte>('B'), static_cast<Byte>('S'), static_cast<Byte>('E'),
        static_cast<Byte>('A'), static_cast<Byte>('L'), static_cast<Byte>('-'),
        static_cast<Byte>('F'), static_cast<Byte>('1'),
    };
    ...
    inline constexpr std::array<Byte, 8> kShardHeaderV1Magic{
        static_cast<Byte>('B'), static_cast<Byte>('S'), static_cast<Byte>('E'),
        static_cast<Byte>('A'), static_cast<Byte>('L'), static_cast<Byte>('-'),
        static_cast<Byte>('S'), static_cast<Byte>('1'),
    };
